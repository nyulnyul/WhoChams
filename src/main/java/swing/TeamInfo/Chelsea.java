...
public class Chelsea extends JFrame implements KeyListener {

    private ImageIcon teamIcon1 = new ImageIcon("src/Logo90/첼시.png");
    private Color b;
    ...
    private void setPanLeft() {
        ...
        updateUniformIcon("src/uniform150x150/chelsea_1.png");
        //라디오버튼
        ...
        rdo1.addActionListener(e -> updateUniformIcon("src/uniform150x150/chelsea_1.png"));
        ...
        rdo2.addActionListener(e -> updateUniformIcon("src/uniform150x150/chelsea_2.png"));
        ...
        rdo3.addActionListener(e -> updateUniformIcon("src/uniform150x150/chelsea_3.png"));
    ...
    private void setPanRight() {
        ...
        //스타디움 라벨
        JLabel stName = new JLabel("스탬퍼드 브리지");
        ...
        //스타디움 이미지
        ImageIcon stIcon = new ImageIcon("src/Stadium_Img/스탬퍼드 브리지_첼시.jpg");
        ...
        JLabel labTrophy2 = new JLabel("리그 : 6회");
        ...
        JLabel labTrophy3 = new JLabel("FA컵 : 8회");
        labTrophy3.setIcon(Trophy3);
        labTrophy3.setFont(new Font("맑은 고딕", Font.BOLD, 17));
