...
public class Munchen extends JFrame implements KeyListener {

    private ImageIcon teamIcon1 = new ImageIcon("src/Logo90/뮌헨.png");
    private Color b;
    ...
    private void setPanLeft() {
        ...
        //페이지 상단 구단명
        JLabel labName = new JLabel("바이에른 뮌헨");
        ...
        updateUniformIcon("src/uniform150x150/bayern1.png");
        //라디오버튼
        ...
        rdo1.addActionListener(e -> updateUniformIcon("src/uniform150x150/bayern1.png"));
        ...
        rdo2.addActionListener(e -> updateUniformIcon("src/uniform150x150/bayern2.png"));
        ...
        rdo3.addActionListener(e -> updateUniformIcon("src/uniform150x150/bayern3.png"));
    ...
    private void setPanRight() {
        ...
        //스타디움 라벨
        JLabel stName = new JLabel("알리안츠 아레나");
        ...
        //스타디움 이미지
        ImageIcon stIcon = new ImageIcon("src/Stadium_Img/알리안츠 아레나_AC밀란.jpg");
        ...
        JLabel labTrophy2 = new JLabel("리그 : 32회");
        ...
        JLabel labTrophy3 = new JLabel("포칼 컵 : 20회");
