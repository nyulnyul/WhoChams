...
public class Inter extends JFrame implements KeyListener {

    private ImageIcon teamIcon1 = new ImageIcon("src/Logo90/인테르.png");
    private Color b;
    ...
    private void setPanLeft() {
        ...
        updateUniformIcon("src/uniform150x150/inter_1.png");
        //라디오버튼
        ...
        rdo1.addActionListener(e -> updateUniformIcon("src/uniform150x150/inter_1.png"));
        ...
        rdo2.addActionListener(e -> updateUniformIcon("src/uniform150x150/inter_2.png"));
        ...
        rdo3.addActionListener(e -> updateUniformIcon("src/uniform150x150/inter_3.png"));
    ...
    private void setPanRight() {
        ...
        JLabel labTrophy1 = new JLabel("챔스 : 3회");
        ...
        JLabel labTrophy3 = new JLabel("코파 이탈리아 : 9회");
