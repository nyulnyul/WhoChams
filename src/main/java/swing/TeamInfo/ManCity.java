...
public class ManCity extends JFrame implements KeyListener {

    private ImageIcon teamIcon1 = new ImageIcon("src/Logo90/맨시티.png");
    private Color b;
    ...
    private void setPanLeft() {
        ...
        //페이지 상단 구단명
        JLabel labName = new JLabel("맨체스터 시티");
        ...
        updateUniformIcon("src/uniform150x150/city_1.png");
        //라디오버튼
        ...
        rdo1.addActionListener(e -> updateUniformIcon("src/uniform150x150/city_1.png"));
        ...
        rdo2.addActionListener(e -> updateUniformIcon("src/uniform150x150/city_2.png"));
        ...
        rdo3.addActionListener(e -> updateUniformIcon("src/uniform150x150/city_3.png"));
    ...
    private void setPanRight() {
        ...
        //스타디움 라벨
        JLabel stName = new JLabel("시티 오브 맨체스터 스타디움");
        ...
        //스타디움 이미지
        ImageIcon stIcon = new ImageIcon("src/Stadium_Img/시티 오브 맨체스터 스타디움_맨시티.jpg");
        ...
        JLabel labTrophy2 = new JLabel("리그 : 9회");
        ...
        JLabel labTrophy3 = new JLabel("FA컵 : 6회");
