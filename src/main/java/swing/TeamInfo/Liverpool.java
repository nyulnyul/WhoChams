...
public class Liverpool extends JFrame implements KeyListener {

    private ImageIcon teamIcon1 = new ImageIcon("src/Logo90/리버풀.png");
    private Color b;
    ...
    private void setPanLeft() {
        ...
        updateUniformIcon("src/uniform150x150/liverpool_1.png");
        //라디오버튼
        ...
        rdo1.addActionListener(e -> updateUniformIcon("src/uniform150x150/liverpool_1.png"));
        ...
        rdo2.addActionListener(e -> updateUniformIcon("src/uniform150x150/liverpool_2.png"));
        ...
        rdo3.addActionListener(e -> updateUniformIcon("src/uniform150x150/liverpool_3.png"));
    ...
    private void setPanRight() {
        ...
        JLabel labTrophy2 = new JLabel("리그 : 19회");
        ...
        JLabel labTrophy3 = new JLabel("국왕컵 : 8회");
