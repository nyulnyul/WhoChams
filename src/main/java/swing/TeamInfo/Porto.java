...
public class Porto extends JFrame implements KeyListener {

    private ImageIcon teamIcon1 = new ImageIcon("src/Logo90/포르투.png");
    private Color b;
    ...
    private void setPanLeft() {
        ...
        //페이지 상단 구단명
        JLabel labName = new JLabel("FC 포르투");
        ...
        JLabel labCaptain = new JLabel("리그 : Premeira Liga");
        ...
        updateUniformIcon("src/uniform150x150/porto1.png");
        //라디오버튼
        ...
        rdo1.addActionListener(e -> updateUniformIcon("src/uniform150x150/porto1.png"));
        ...
        rdo2.addActionListener(e -> updateUniformIcon("src/uniform150x150/porto2.png"));
        ...
        rdo3.addActionListener(e -> updateUniformIcon("src/uniform150x150/porto3.png"));
    ...
    private void setPanRight() {
        ...
        //스타디움 라벨
        JLabel stName = new JLabel("아스타디우 두 드라강");
        ...
        //스타디움 이미지
        ImageIcon stIcon = new ImageIcon("src/Stadium_Img/아스타디우 두 드라강_포르투.jpg");
        ...
        JLabel labTrophy2 = new JLabel("리그 : 30회");
        ...
        JLabel labTrophy3 = new JLabel("<html>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;타사 드<br>" + "포르투갈 : 18회");
        labTrophy3.setIcon(Trophy3);
        labTrophy3.setFont(new Font("맑은 고딕", Font.BOLD, 14));
