...
public class Milan extends JFrame implements KeyListener {

    private ImageIcon teamIcon1 = new ImageIcon("src/Logo90/AC밀란.png");
    private Color b;
    ...
    private void setPanLeft() {
        ...
        //페이지 상단 구단명
        JLabel labName = new JLabel("AC밀란");
        ...
        updateUniformIcon("src/uniform150x150/milan_1.png");
        //라디오버튼
        ...
        rdo1.addActionListener(e -> updateUniformIcon("src/uniform150x150/milan_1.png"));
        ...
        rdo2.addActionListener(e -> updateUniformIcon("src/uniform150x150/milan_2.png"));
        ...
        rdo3.addActionListener(e -> updateUniformIcon("src/uniform150x150/milan_3.png"));
    ...
    private void setPanRight() {
        ...
        //스타디움 이미지
        ImageIcon stIcon = new ImageIcon("src/Stadium_Img/산 시로_인테르, AC밀란.jpg");
        ...
        JLabel labTrophy3 = new JLabel("코파 이탈리아 : 5회");
