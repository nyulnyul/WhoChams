...
public class Tottenhem extends JFrame implements KeyListener {

    private ImageIcon teamIcon1 = new ImageIcon("src/Logo90/토트넘.png");
    private Color b;
    ...
    private void setPanLeft() {
        ...
        //페이지 상단 구단명
        JLabel labName = new JLabel("토트넘 훗스퍼");
        ...
        updateUniformIcon("src/uniform150x150/tottenham_1.png");
        //라디오버튼
        ...
        rdo1.addActionListener(e -> updateUniformIcon("src/uniform150x150/tottenham_1.png"));
        ...
        rdo2.addActionListener(e -> updateUniformIcon("src/uniform150x150/tottenham_2.png"));
        ...
        rdo3.addActionListener(e -> updateUniformIcon("src/uniform150x150/tottenham_3.png"));
    ...
    private void setPanRight() {
        ...
        //스타디움 라벨
        JLabel stName = new JLabel("토트넘 훗스퍼 스타디움");
        ...
        //스타디움 이미지
        ImageIcon stIcon = new ImageIcon("src/Stadium_Img/토트넘 훗스퍼 스타디움_토트넘.jpg");
        ...
        JLabel labTrophy2 = new JLabel("리그 : 2회");
        ...
        JLabel labTrophy3 = new JLabel("FA : 8회");
