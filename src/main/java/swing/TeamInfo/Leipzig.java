...
public class Leipzig extends JFrame implements KeyListener {

    private ImageIcon teamIcon1 = new ImageIcon("src/Logo90/라히프치히.png");
    private Color b;
    ...
    private void setPanLeft() {
        ...
        //페이지 상단 구단명
        JLabel labName = new JLabel("라히프치히");
        ...
        updateUniformIcon("src/uniform150x150/leipzig1.png");
        //라디오버튼
        ...
        rdo1.addActionListener(e -> updateUniformIcon("src/uniform150x150/leipzig1.png"));
        ...
        rdo2.addActionListener(e -> updateUniformIcon("src/uniform150x150/leipzig2.png"));
        ...
        rdo3.addActionListener(e -> updateUniformIcon("src/uniform150x150/leipzig3.png"));
    ...
    private void setPanRight() {
        ...
        //스타디움 라벨
        JLabel stName = new JLabel("레드불 아레나");
        ...
        //스타디움 이미지
        ImageIcon stIcon = new ImageIcon("src/Stadium_Img/레드불 아레나_라히프치히.jpg");
        ...
        JLabel labTrophy3 = new JLabel("포칼컵 : 1회");
