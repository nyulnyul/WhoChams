...
public class Brugge extends JFrame implements KeyListener {

    private ImageIcon teamIcon1 = new ImageIcon("src/Logo90/브뤼헤.png");
    private Color b;
    ...
    private void setPanLeft() {
        ...
        updateUniformIcon("src/uniform150x150/brugge_1.png");
        //라디오버튼
        ...
        rdo1.addActionListener(e -> updateUniformIcon("src/uniform150x150/brugge_1.png"));
        ...
        rdo2.addActionListener(e -> updateUniformIcon("src/uniform150x150/brugge_2.png"));
        ...
        rdo3.addActionListener(e -> updateUniformIcon("src/uniform150x150/brugge_3.png"));
    ...
    private void setPanRight() {
        ...
        //스타디움 라벨
        JLabel stName = new JLabel("얀 브레이덜 스타디움");
        ...
        //스타디움 이미지
        ImageIcon stIcon = new ImageIcon("src/Stadium_Img/얀 브레이덜 스타디움_브뤼헤.jpg");
        ...
        JLabel labTrophy2 = new JLabel("리그 : 17회");
        ...
        JLabel labTrophy3 = new JLabel("벨기에컵 : 11회");
        labTrophy3.setIcon(Trophy3);
        labTrophy3.setFont(new Font("맑은 고딕", Font.BOLD, 16));
    ...
    //라디오 버튼 클릭 후 ESC 클릭 시에도 종료할 수 있게
    private void setRdo() {
