...
public class Frankfurt extends JFrame implements KeyListener {

    private ImageIcon teamIcon1 = new ImageIcon("src/Logo90/프랑크.png");
    private Color b;
    ...
    private void setPanLeft() {
        ...
        //페이지 상단 구단명
        JLabel labName = new JLabel("프랑크푸르트");
        ...
        updateUniformIcon("src/uniform150x150/frankfurt1.png");
        //라디오버튼
        ...
        rdo1.addActionListener(e -> updateUniformIcon("src/uniform150x150/frankfurt1.png"));
        ...
        rdo2.addActionListener(e -> updateUniformIcon("src/uniform150x150/frankfurt2.png"));
        ...
        rdo3.addActionListener(e -> updateUniformIcon("src/uniform150x150/frankfurt3.png"));
    ...
    private void setPanRight() {
        ...
        //스타디움 라벨
        JLabel stName = new JLabel("도이체 방크 파르크");
        ...
        //스타디움 이미지
        ImageIcon stIcon = new ImageIcon("src/Stadium_Img/도이체 방크 파르크_프랑크푸르트.jpg");
        ...
        JLabel labTrophy2 = new JLabel("리그 : 0회");
