...
public class Dortmund extends JFrame implements KeyListener {

    private ImageIcon teamIcon1 = new ImageIcon("src/Logo90/도르트문트.png");
    private Color b;
    ...
    private void setPanLeft() {
        ...
        //페이지 상단 구단명
        JLabel labName = new JLabel("도르트문트");
        ...
        updateUniformIcon("src/uniform150x150/dortmund1.png");
        //라디오버튼
        ...
        rdo1.addActionListener(e -> updateUniformIcon("src/uniform150x150/dortmund1.png"));
        ...
        rdo2.addActionListener(e -> updateUniformIcon("src/uniform150x150/dortmund2.png"));
        ...
        rdo3.addActionListener(e -> updateUniformIcon("src/uniform150x150/dortmund3.png"));
    ...
    private void setPanRight() {
        ...
        //스타디움 라벨
        JLabel stName = new JLabel("지그날 이두나 파르크");
        ...
        JLabel labTrophy2 = new JLabel("리그 : 5회");
        ...
        JLabel labTrophy3 = new JLabel("포칼컵 : 5회");
